defmodule Trenino.Repo.Migrations.ConsolidateMotorEnablePin do
  ...
  def up do
    ...
    execute(
      "UPDATE device_inputs SET motor_enable = motor_enable_a WHERE motor_enable_a IS NOT NULL"
    )
  ...
  def down do
    ...
    execute(
      "UPDATE device_inputs SET motor_enable_a = motor_enable WHERE motor_enable IS NOT NULL"
    )
