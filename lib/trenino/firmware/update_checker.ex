defmodule Trenino.Firmware.UpdateChecker do
  @moduledoc """
  ...
  def init(opts) do
    ...
    check_interval_ms =
      Keyword.get(
        opts,
        :check_interval_ms,
        Application.get_env(:trenino, :firmware_check_interval_ms, @default_check_interval_ms)
      )
    ...
    Phoenix.PubSub.subscribe(Trenino.PubSub, @device_updates_topic)
  ...
  defp broadcast(event) do
    Phoenix.PubSub.broadcast(Trenino.PubSub, @pubsub_topic, event)
  end
