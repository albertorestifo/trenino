defmodule Trenino.AppVersion.UpdateChecker do
  @moduledoc """
  ...
  def init(_opts) do
    check_interval_ms =
      Application.get_env(:trenino, :app_version_check_interval_ms, @default_check_interval_ms)
