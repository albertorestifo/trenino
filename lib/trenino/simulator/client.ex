defmodule Trenino.Simulator.Client do
  @moduledoc """
  ...
  Create a client with the base URL and API key:
      ...
      client = Trenino.Simulator.Client.new("http://localhost:31270", "your-api-key")
  ...
  ## Usage
      ...
      # Get current speed
      {:ok, response} = Trenino.Simulator.Client.get(client, "CurrentDrivableActor.Function.HUD_GetSpeed")

      # Set throttle position
      {:ok, response} = Trenino.Simulator.Client.set(client, "CurrentDrivableActor/Throttle(Lever).InputValue", 0.5)

      # List available controls
      {:ok, nodes} = Trenino.Simulator.Client.list(client, "CurrentDrivableActor")
  """
  ...
  ## Examples
      ...
      iex> client = Trenino.Simulator.Client.new("http://localhost:31270", "your-api-key")
      %Trenino.Simulator.Client{base_url: "http://localhost:31270", api_key: "your-api-key", ...}
  ...
  ## Examples
      ...
      # List all root nodes
      {:ok, nodes} = Trenino.Simulator.Client.list(client)
  ...
  ## Examples
      ...
      {:ok, %{"Result" => "Success", "Values" => %{"Speed (ms)" => 4.54}}} =
        Trenino.Simulator.Client.get(client, "CurrentDrivableActor.Function.HUD_GetSpeed")

      # Get throttle notch position
      {:ok, response} = Trenino.Simulator.Client.get(
        client,
  ...
  ## Examples
      ...
      {:ok, 5} = Trenino.Simulator.Client.get_int(client, "CurrentFormation.FormationLength")
  ...
  ## Examples
      ...
      {:ok, 4.54} = Trenino.Simulator.Client.get_float(client, "CurrentDrivableActor.Function.HUD_GetSpeed")
  ...
  ## Examples
      ...
      {:ok, "BR_Class_66_DB"} = Trenino.Simulator.Client.get_string(client, "CurrentFormation/0.ObjectClass")
  ...
  ## Examples
      ...
      # Set throttle position
      {:ok, %{"Result" => "Success"}} =
        Trenino.Simulator.Client.set(client, "CurrentDrivableActor/Throttle(Lever).InputValue", 0.25)

      # Set weather cloudiness
      {:ok, response} = Trenino.Simulator.Client.set(client, "WeatherManager.Cloudiness", 0.5)
  ...
  ## Examples
      ...
      {:ok, response} = Trenino.Simulator.Client.subscribe(
        client,
  ...
  ## Examples
      ...
      {:ok, %{"Entries" => entries}} = Trenino.Simulator.Client.get_subscription(client, 1)
  ...
  ## Examples
      ...
      {:ok, response} = Trenino.Simulator.Client.unsubscribe(client, 1)
  ...
  ## Examples
      ...
      {:ok, subscriptions} = Trenino.Simulator.Client.list_subscriptions(client)
