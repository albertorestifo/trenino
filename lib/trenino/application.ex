defmodule Trenino.Application do
  ...
  # Returns the DisplayController child spec only in non-test environments.
  # In test, this GenServer subscribes to pubsub topics and interacts
  # with other GenServers that may not be running.
  defp display_controller_child do
    if Application.get_env(:trenino, :start_display_controller, true) do
