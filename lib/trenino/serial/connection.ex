defmodule Trenino.Serial.Connection do
  @moduledoc """
  Manages connections to trenino devices over serial ports.
  ...
  alias Trenino.Serial.Discovery
  alias Trenino.Serial.Framing
  ...
  def subscribe_messages(port) do
    Phoenix.PubSub.subscribe(Trenino.PubSub, "#{@serial_messages_topic}:#{port}")
  end
  ...
  defp broadcast_update(state) do
    ...
    Phoenix.PubSub.broadcast(Trenino.PubSub, @pubsub_topic, {:devices_updated, devices})
  end

  defp broadcast_scan_complete do
    Phoenix.PubSub.broadcast(Trenino.PubSub, @pubsub_topic, :scan_complete)
  end
