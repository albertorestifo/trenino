defmodule Trenino.Firmware do
  ...
  defdelegate check_for_updates(), to: Trenino.Firmware.Downloader
  defdelegate download_firmware(firmware_file_id), to: Trenino.Firmware.Downloader
  ...
  defdelegate firmware_file_path(file), to: Trenino.Firmware.FilePath, as: :firmware_path

  defdelegate firmware_file_path(version, board_type),
    to: Trenino.Firmware.FilePath,
    as: :firmware_path

  defdelegate firmware_cache_dir(), to: Trenino.Firmware.FilePath, as: :cache_dir
