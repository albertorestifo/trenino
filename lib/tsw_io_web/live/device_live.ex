defmodule TswIoWeb.DeviceLive do
  ...
  def mount(_params, _session, socket) do
    # NavHook handles subscriptions and nav state
    {:ok, socket}
  end

  # PubSub handlers - update nav state from NavHook
  @impl true
  ...
  def render(assigns) do
    ...
    <div class="min-h-screen flex flex-col">
      ...
      <main class="flex-1 p-4 sm:p-8">
        <.main_content devices={@nav_devices} />
      </main>
    </div>
    """
  end
  ...
  defp device_config_state(assigns) do
    ...
    <div>
      ...
      <.unknown_config_state :if={!@has_config} device={@device} />
